...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `mcpwatchtower` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in mcpwatchtower.
